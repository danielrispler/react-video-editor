...
export type GetSignedUrlRequest = import("@sinclair/typebox").Static<
	typeof getSignedUrlBodySchema
>;
export type CleanupRequest = import("@sinclair/typebox").Static<
	typeof cleanupBodySchema
>;
