...
export const calculateAudioProcessing = (
    ...
    return {
        needsTrim,
        needsVolume,
        needsTimelineTrim: needsTimelineTrim && timelineTrimDuration !== null && timelineTrimDuration > 0,
        audioTrimStart,
        extractDuration
    };
};
...
export const processAudioFile = async (
    ...
    const needsProcessing = processing.needsTrim || processing.needsVolume || processing.needsTimelineTrim;
    ...
    await runFfmpeg((command) => {
        ...
        const cmdWithSeek = processing.audioTrimStart > 0
        ...
        const cmdWithFilters = filters.length > 0
        ...
        return cmdWithFilters
            ...
            .audioChannels(2)
            .outputOptions([FFMPEG_COMMAND.HIDE_BANNER, FFMPEG_COMMAND.OVERWRITE_OUTPUT])
