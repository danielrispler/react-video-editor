...
// ../../node_modules/.pnpm/@designcombo+state@5.5.8_@designcombo+events@1.0.2_@designcombo+types@5.5.8/node_modules/@designcombo/state/dist/index.es.js
var Hs = Object.defineProperty;
var Us = (t, r, e) => r in t ? Hs(t, r, { enumerable: true, configurable: true, writable: true, value: e }) : t[r] = e;
...
var ls = (function(t) {
  ...
  function r(e) {
    ...
    return n.isStopped = false, e ? (n.destination = e, us(e) && e.add(n)) : n.destination = Ks, n;
  }
...
(function(t, r) {
  ...
  $[et] = $[Qt] = $[te] = $[Se] = $[we] = $[Te] = $[Me] = $[z] = $[Ee] = true, $[c] = $[d] = $[x] = $[h] = $[F] = $[y] = $[m] = $[I] = $[b] = $[S] = $[v] = $[E] = $[_] = $[M] = $[G] = false;
  var re = typeof ft == "object" && ft && ft.Object === Object && ft, xe = typeof self == "object" && self && self.Object === Object && self, it = re || xe || Function("return this")(), ne = r && !r.nodeType && r, se = ne && true && t && !t.nodeType && t, $t = se && se.exports === ne, Ft = $t && re.process, ie = (function() {
    try {
  ...
  ), Wt = $t ? it.Buffer : void 0, Et = it.Symbol, fe = it.Uint8Array, At = yt.propertyIsEnumerable, gt = Tt.splice, at = Et ? Et.toStringTag : void 0, xt = Object.getOwnPropertySymbols, jt = Wt ? Wt.isBuffer : void 0, It = ue(Object.keys, Object), Bt = Ct(it, "DataView"), bt = Ct(it, "Map"), Yt = Ct(it, "Promise"), Gt = Ct(it, "Set"), We = Ct(it, "WeakMap"), Xt = Ct(Object, "create"), ar = nt(Bt), Ot = nt(bt), xr = nt(Yt), Or = nt(Gt), Cr = nt(We), or2 = Et ? Et.prototype : void 0, je = or2 ? or2.valueOf : void 0;
  function X(i) {
  ...
  function Nr(i) {
    ...
    if (l < 0)
      return false;
    var g = o.length - 1;
    return l == g ? o.pop() : gt.call(o, l, 1), --this.size, true;
  }
  function Lr(i) {
    var o = this.__data__, l = $e(o, i);
  ...
  function lr(i, o, l, g, O) {
    return i === o ? true : i == null || o == null || !_t(i) && !_t(o) ? i !== i && o !== o : Zr(i, o, l, g, lr, O);
  }
  function Zr(i, o, l, g, O, A) {
    ...
    return B ? (A || (A = new kt()), nn(i, o, l, g, O, A)) : false;
  }
  function Qr(i) {
    if (!mr(i) || cn(i))
      return false;
  ...
  function Ge(i, o, l, g, O, A) {
    ...
    if (N && A.get(o))
      return N == o;
    var Z = -1, ct = true, B = l & a ? new De() : void 0;
  ...
  function nn(i, o, l, g, O, A) {
    ...
    if (K && !Kt) {
      ...
      gr != Ir && "constructor" in i && "constructor" in o && !(typeof gr == "function" && gr instanceof gr && typeof Ir == "function" && Ir instanceof Ir) && (K = false);
    }
...
var ui = `${H}:video`;
var li = `${H}:audio`;
var Eo = `${H}:placeholder`;
var di = `${H}:image`;
var fi = `${H}:illustration`;
var pi = `${H}:shape`;
var Ao = `${H}:mask`;
var xo = `${H}:transition`;
var hi = `${H}:animation`;
...
var yi = `${H}:template`;
var gi = `${H}:items`;
var Ii = `${H}:composition`;
var bi = `${H}:progressBar`;
var ki = `${H}:progressFrame`;
var vi = `${H}:radialAudioBars`;
var _i = `${H}:linealAudioBars`;
var Si = `${H}:progressSquare`;
var wi = `${H}:waveAudioBars`;
var Ti = `${H}:hillAudioBars`;
var Mi = `${H}:rect`;
var zt = "edit";
var Ei = `${zt}:object`;
var Ai = `${zt}:replaceMedia`;
var Oo = `${zt}:text`;
var Co = `${zt}:shape`;
var Ro = `${zt}:templateItem`;
var Po = `${zt}:deleteTemplateItem`;
var xi = `${zt}:backgroundEditor`;
var Oi = `${zt}:track`;
var Do = "enterEditMode";
var Le = "active";
var zo = `${Le}:set`;
var $o = `${Le}:delete`;
var Ci = `${Le}:paste`;
...
(function(t, r) {
  ...
  z[a] = z[u] = z[E] = z[_] = z[c] = z[d] = z[M] = z[L] = z[R] = z[G] = z[x] = z[m] = z[I] = z[k] = z[S] = z[f] = z[v] = z[T] = z[F] = z[et] = z[Qt] = z[te] = true, z[p] = z[h] = z[w] = false;
  var Ee = typeof ft == "object" && ft && ft.Object === Object && ft, Ae = typeof self == "object" && self && self.Object === Object && self, st = Ee || Ae || Function("return this")(), ee = r && !r.nodeType && r, $ = ee && true && t && !t.nodeType && t, re = $ && $.exports === ee;
  function xe(i, o) {
  ...
  function ne(i, o) {
    for (var l = -1, g = i ? i.length : 0; ++l < g && o(i[l], l, i) !== false; )
      ;
    return i;
  }
  function se(i, o) {
  ...
  Ot.prototype.clear = xr, Ot.prototype.delete = Or, Ot.prototype.get = Cr, Ot.prototype.has = or2, Ot.prototype.set = je;
  function X(i) {
    var o = -1, l = i ? i.length : 0;
    for (this.clear(); ++o < l; ) {
      var g = i[o];
  ...
  function Pr(i) {
    ...
    if (l < 0)
      return false;
    var g = o.length - 1;
    return l == g ? o.pop() : Pe.call(o, l, 1), true;
  }
  function Dr(i) {
    var o = this.__data__, l = ze(o, i);
    return l < 0 ? void 0 : o[l][1];
...
var j = (t) => Object.keys(t).reduce((r, e) => {
  const { display: n } = t[e];
...
var He = (t) => {
  ...
  return r.length === 0 ? Promise.resolve(true) : new Promise((e, n) => {
    Promise.all(r).then((s) => {
      s.forEach((a) => {
        a && a.family && (document.fonts.add(a), e(true));
      });
    }).catch((s) => n(s));
  });
};
...
var Dn = () => Sr.cors;
var ms = () => Sr.acceptsMap;
var Ue = (t) => new Promise((r, e) => {
  const n = new Image();
  n.onload = () => {
...
var na = async (t, r) => {
  ...
  return {
    ...
    details: {
      ...
      flipX: (s == null ? void 0 : s.flipX) || false,
      flipY: (s == null ? void 0 : s.flipY) || false,
...
var Es = async (t, r) => {
  ...
  return {
    ...
    details: {
      ...
      preservedColorKeyWord: s.preservedColorKeyWord || false,
...
function ua(t) {
  ...
  n.filter((d) => a.has(d.id) ? false : (a.add(d.id), true)), s.tracks = Array.from(a), s.activeIds.forEach((d) => {
...
function Aa(t) {
  const r = ir.pipe(
    or(({ key: f }) => f.startsWith(Kn))
  ), e = ir.pipe(
    or(({ key: f }) => f.startsWith(Rn))
  ), n = ir.pipe(
    or(({ key: f }) => f.startsWith(H))
  ), s = ir.pipe(
    or(({ key: f }) => f.startsWith(tt))
  ), a = ir.pipe(
    or(({ key: f }) => f.startsWith(Er))
  ), u = ir.pipe(
    or(({ key: f }) => f.startsWith(Le))
  ), c = ir.pipe(
    or(({ key: f }) => f.startsWith(zt))
  ), d = ir.pipe(
    or(({ key: f }) => f.startsWith(fs))
  ), p = r.subscribe(async (f) => {
    var v;
    if (f.key === Kn) {
      const { actions: T } = (v = f.value) == null ? void 0 : v.payload;
      T.forEach((w) => {
        sr(w.type, w.payload && { payload: w.payload });
      });
    }
    ...
    if (f.key === Di && ua(t.getState()), f.key === $i) {
      ...
      t.updateState(M, { updateHistory: true, kind: "remove" });
    }
    if (f.key === zi) {
      const _ = qi(
        t.getState(),
    ...
    const v = C(t.getState()), T = ((R = (L = f.value) == null ? void 0 : L.options) == null ? void 0 : R.isSelected) || false, w = (x = (G = f.value) == null ? void 0 : G.options) == null ? void 0 : x.scaleMode, E = (et = (F = f.value) == null ? void 0 : F.options) == null ? void 0 : et.scaleAspectRatio, _ = (te = (Qt = f.value) == null ? void 0 : Qt.options) == null ? void 0 : te.trackIndex;
    let M = {};
...
var xa = { Date: true, RegExp: true, String: true, Number: true };
function Rs(t, r, e = { cyclesFix: true }, n = []) {
  var c, d;
  let s = [];
...
var Je = Symbol.for("immer-draftable");
var lt = Symbol.for("immer-state");
var Ps = true ? [
...
function Zt(t) {
  var r;
  return t ? Ds(t) || Array.isArray(t) || !!t[Je] || !!((r = t.constructor) != null && r[Je]) || sr2(t) || ir2(t) : false;
}
...
function Ds(t) {
  ...
  return e === Object ? true : typeof e == "function" && Function.toString.call(e) === Oa;
}
function Ze(t, r) {
...
function ve(t) {
  const r = t[lt];
  return r ? r.type_ : Array.isArray(t) ? 1 : sr2(t) ? 2 : ir2(t) ? 3 : 0;
}
function Qe(t, r) {
...
function Tn(t, r) {
  ...
  if (r === true || r === "class_only" && !e) {
    ...
    for (let a = 0; a < s.length; a++) {
      const u = s[a], c = n[u];
      c.writable === false && (c.writable = true, c.configurable = true), (c.get || c.set) && (n[u] = {
        configurable: true,
        writable: true,
...
function Fn(t, r = false) {
  return Ar(t) || ke(t) || !Zt(t) || (ve(t) > 1 && (t.set = t.add = t.clear = t.delete = Ra), Object.freeze(t), r && Object.entries(t).forEach(([e, n]) => Fn(n, true))), t;
}
function Ra() {
  Y(2);
}
...
function wr(t, r, e) {
  ...
  if (!n.finalized_) {
    ...
    const s = n.copy_;
    let a = s, u = false;
    n.type_ === 3 && (a = new Set(s), s.clear(), u = true), Ze(
      a,
      (c, d) => ts(t, n, s, c, d, e, u)
    ), Tr(t, s, false), e && t.patches_ && _e("Patches").generatePatches_(
      n,
      e,
      t.patches_,
      t.inversePatches_
...
var Nn = {
  ...
  deleteProperty(t, r) {
    return gn(t.base_, r) !== void 0 || r in t.base_ ? (t.assigned_[r] = false, In(t), xn(t)) : delete t.assigned_[r], t.copy_ && delete t.copy_[r], true;
  },
...
er.deleteProperty = function(t, r) {
  return isNaN(parseInt(r)) && Y(13), er.set.call(this, t, r, void 0);
};
er.set = function(t, r, e) {
  return r !== "length" && isNaN(parseInt(r)) && Y(14), Nn.set.call(this, t[0], r, e, t[0]);
};
function gn(t, r) {
  const e = t[lt];
  return (e ? ge(e) : t)[r];
...
var Na = class {
  constructor(t) {
    this.autoFreeze_ = true, this.useStrictShallowCopy_ = false, this.produce = (r, e, n) => {
      ...
      if (Zt(r)) {
        ...
        if (s = e(r), s === void 0 && (s = r), s === $n && (s = void 0), this.autoFreeze_ && Fn(s, true), n) {
          const a = [], u = [];
  ...
  createDraft(t) {
    ...
    return e[lt].isManual_ = true, An(r), e;
  }
  finishDraft(t, r) {
    const e = t && t[lt];
    (!e || !e.isManual_) && Y(9);
...
function On(t, r) {
  const e = sr2(t) ? _e("MapSet").proxyMap_(t, r) : ir2(t) ? _e("MapSet").proxySet_(t, r) : $a(t, r);
...
var Ya = "[object GeneratorFunction]";
var Ga = "[object Symbol]";
var Xa = typeof ft == "object" && ft && ft.Object === Object && ft;
var Ka = typeof self == "object" && self && self.Object === Object && self;
var Va = Xa || Ka || Function("return this")();
function qa(t, r, e) {
  switch (e.length) {
    case 0:
      return t.call(r);
...
var Qa = Ln.hasOwnProperty;
var Hn = Ln.toString;
var rs = Va.Symbol;
var to = Ln.propertyIsEnumerable;
var ns = rs ? rs.isConcatSpreadable : void 0;
var ss = Math.max;
...
var Vo = class {
  ...
  undo() {
    ...
    this.stateSubject.next({ ...R, duration: G }), this.stateHistorySubject.next({ handleRedo: false, handleUndo: true }), this.updateState(R, { updateHistory: false });
  }
  applyPatch(r, e) {
  ...
  redo() {
    ...
    const G = j(R.trackItemsMap);
    this.stateSubject.next({ ...R, duration: G }), this.stateHistorySubject.next({ handleRedo: true, handleUndo: false }), this.updateState(R, { updateHistory: false });
  }
  toJSON() {
    const {
      fps: r,
