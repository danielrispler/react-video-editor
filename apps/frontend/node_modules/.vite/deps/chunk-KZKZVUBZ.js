...
// ../../node_modules/.pnpm/remotion@4.0.456_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/remotion/dist/esm/index.mjs
...
var RegularSequenceRefForwardingFunction = ({
  ...
  const env = useRemotionEnvironment();
  const inheritedStack = (other == null ? void 0 : other.stack) ?? null;
...
var PremountedPostmountedSequenceRefForwardingFunction = (props, ref) => {
  ...
  return (0, import_jsx_runtime12.jsx)(Freeze, {
    ...
    children: (0, import_jsx_runtime12.jsx)(Sequence, {
      ref,
      from,
      durationInFrames,
      style,
...
var Sequence = (0, import_react25.forwardRef)(SequenceRefForwardingFunction);
...
var AnimatedImage = (0, import_react32.forwardRef)(({
  src,
  width,
  height,
  onError,
  ...
  const mountState = (0, import_react32.useRef)({ isMounted: true });
...
var useSchema = (schema, currentValue) => {
  const env = useRemotionEnvironment();
  const earlyReturn = (0, import_react36.useMemo)(() => {
  ...
  const [overrideId] = (0, import_react36.useState)(() => String(Math.random()));
  const {
    visualModeEnabled,
    dragOverrides: overrides,
    codeValues
  } = (0, import_react36.useContext)(VisualModeOverridesContext);
  const controls = (0, import_react36.useMemo)(() => {
  ...
  return (0, import_react36.useMemo)(() => {
    var _a;
    if (controls === void 0 || currentValue === null || schema === null || !visualModeEnabled) {
      return {
        controls: void 0,
        values: currentValue ?? {}
      };
    ...
    for (const key of keysToUpdate) {
      const codeValueStatus = (propStatus == null ? void 0 : propStatus[key]) ?? null;
      merged[key] = getEffectiveVisualModeValue({
        codeValue: codeValueStatus,
        runtimeValue: currentValue[key],
        dragOverrideValue: overrideValues[key],
        defaultValue: (_a = schema[key]) == null ? void 0 : _a.default,
        shouldResortToDefaultValueIfUndefined: false
      });
    }
    return {
...
var wrapInSchema = (Component, schema) => {
  ...
  const Wrapped = (0, import_react35.forwardRef)((props, ref) => {
    ...
    const schemaInput = (0, import_react35.useMemo)(() => {
      const input = {};
      for (const key of schemaKeys) {
...
var isHtmlInCanvasSupported = () => {
  ...
  const canvas = document.createElement("canvas");
  const ctx = canvas.getContext("2d");
  cachedSupport = typeof (ctx == null ? void 0 : ctx.drawElementImage) === "function" && typeof canvas.requestPaint === "function" && typeof canvas.captureElementImage === "function";
  return cachedSupport;
};
...
var HtmlInCanvasInner = (0, import_react34.forwardRef)(({
  width,
  height,
  _experimentalEffects: experimentalEffects = [],
  children,
  ...
  const frame = useCurrentFrame();
  const canvas2dRef = (0, import_react34.useRef)(null);
  const divRef = (0, import_react34.useRef)(null);
  const setLayoutCanvasRef = (0, import_react34.useCallback)((node) => {
  ...
  const [offscreenCanvas] = (0, import_react34.useState)(() => new OffscreenCanvas(1, 1));
  const chainState = useEffectChainState();
  const effectsRef = (0, import_react34.useRef)(experimentalEffects);
  effectsRef.current = experimentalEffects;
  const frameRef = (0, import_react34.useRef)(frame);
  frameRef.current = frame;
  const onPaintRef = (0, import_react34.useRef)(onPaint);
  onPaintRef.current = onPaint;
  const onInitRef = (0, import_react34.useRef)(onInit);
  onInitRef.current = onInit;
  const initializedRef = (0, import_react34.useRef)(false);
  const onInitCleanupRef = (0, import_react34.useRef)(null);
  const unmountedRef = (0, import_react34.useRef)(false);
  const onPaintCb = (0, import_react34.useCallback)(async () => {
  ...
  const onPaintChangedRef = (0, import_react34.useRef)(false);
  (0, import_react34.useLayoutEffect)(() => {
    var _a;
  ...
  const innerStyle = (0, import_react34.useMemo)(() => {
    return {
      width,
      height,
      ...style
...
var RenderAssetManagerProvider = ({ children, collectAssets }) => {
  const [renderAssets, setRenderAssets] = (0, import_react38.useState)([]);
  const renderAssetsRef = (0, import_react38.useRef)([]);
  const registerRenderAsset = (0, import_react38.useCallback)((renderAsset) => {
    validateRenderAsset(renderAsset);
    renderAssetsRef.current = [...renderAssetsRef.current, renderAsset];
    setRenderAssets(renderAssetsRef.current);
  }, []);
  if (collectAssets) {
    (0, import_react38.useImperativeHandle)(collectAssets, () => {
      return {
        collectAssets: () => {
...
var DurationsContextProvider = ({ children }) => {
  const [durations, setDurations] = (0, import_react43.useReducer)(durationReducer, {});
...
var SharedAudioContext = (0, import_react46.createContext)(null);
var SharedAudioTagsContext = (0, import_react46.createContext)(null);
var SharedAudioContextProvider = ({ children, audioLatencyHint, audioEnabled }) => {
  ...
  const audioContextIsPlayingEventually = (0, import_react46.useRef)(false);
  const isResuming = (0, import_react46.useRef)(null);
  const audioSyncAnchor = (0, import_react46.useMemo)(() => ({ value: 0 }), []);
  const audioSyncAnchorListeners = (0, import_react46.useRef)([]);
  const audioSyncAnchorEmitter = (0, import_react46.useMemo)(() => {
    return {
      dispatch: (event) => {
  ...
  const prevEndTimes = (0, import_react46.useRef)({ scheduledEndTime: null, mediaEndTime: null });
  const nodesToResume = (0, import_react46.useRef)(/* @__PURE__ */ new Map());
  const unscheduleAudioNode = (0, import_react46.useCallback)((node) => {
    nodesToResume.current.delete(node);
  }, []);
  const scheduleAudioNode = (0, import_react46.useMemo)(() => {
    return ({
      node,
      mediaTimestamp,
      currentTime,
  ...
  const resume = (0, import_react46.useCallback)(() => {
    var _a, _b;
    if (!ctxAndGain) {
    ...
    isResuming.current = waitUntilActuallyResumed(ctxAndGain.audioContext, logLevel).then(() => {
    }).finally(() => {
      isResuming.current = null;
    });
    ctxAndGain.gainNode.gain.cancelScheduledValues(ctxAndGain.audioContext.currentTime);
    (_a = ctxAndGain.gainNode) == null ? void 0 : _a.gain.setValueAtTime(0, ctxAndGain.audioContext.currentTime);
    (_b = ctxAndGain.gainNode) == null ? void 0 : _b.gain.linearRampToValueAtTime(1, ctxAndGain.audioContext.currentTime + 0.03);
  ...
  const getIsResumingAudioContext = (0, import_react46.useCallback)(() => {
    return isResuming.current;
  }, []);
  const suspend = (0, import_react46.useCallback)(() => {
    if (!ctxAndGain) {
      return;
    }
    if (!audioContextIsPlayingEventually.current) {
  ...
  const audioContextValue = (0, import_react46.useMemo)(() => {
    return {
...
var SharedAudioTagsContextProvider = ({ children, numberOfAudioTags }) => {
  const audios = (0, import_react46.useRef)([]);
  const [initialNumberOfAudioTags] = (0, import_react46.useState)(numberOfAudioTags);
  ...
  const env = useRemotionEnvironment();
  const audioCtx = (0, import_react46.useContext)(SharedAudioContext);
  const audioContext = (audioCtx == null ? void 0 : audioCtx.audioContext) ?? null;
  const resume = audioCtx == null ? void 0 : audioCtx.resume;
  const refs = (0, import_react46.useMemo)(() => {
    return new Array(numberOfAudioTags).fill(true).map(() => {
      const ref = (0, import_react46.createRef)();
      return {
        id: Math.random(),
        ref,
  ...
  const effectToUse = import_react46.default.useInsertionEffect ?? import_react46.default.useLayoutEffect;
  effectToUse(() => {
    return () => {
  ...
  const takenAudios = (0, import_react46.useRef)(new Array(numberOfAudioTags).fill(false));
  const rerenderAudios = (0, import_react46.useCallback)(() => {
    refs.forEach(({ ref, id }) => {
      var _a;
  ...
  const registerAudio = (0, import_react46.useCallback)((options) => {
    var _a, _b;
  ...
  const unregisterAudio = (0, import_react46.useCallback)((id) => {
    var _a;
    const cloned = [...takenAudios.current];
  ...
  const updateAudio = (0, import_react46.useCallback)(({
    aud,
    audioId,
    id,
    premounting,
  ...
  const playAllAudios = (0, import_react46.useCallback)(() => {
    refs.forEach((ref) => {
  ...
  const audioTagsValue = (0, import_react46.useMemo)(() => {
    return {
      registerAudio,
      unregisterAudio,
      updateAudio,
...
var useSharedAudio = ({
  ...
  const audioCtx = (0, import_react46.useContext)(SharedAudioContext);
  const tagsCtx = (0, import_react46.useContext)(SharedAudioTagsContext);
  const [elem] = (0, import_react46.useState)(() => {
    if (tagsCtx && tagsCtx.numberOfAudioTags > 0) {
      return tagsCtx.registerAudio({ aud, audioId, premounting, postmounting });
    }
    const el = import_react46.default.createRef();
    const mediaElementSourceNode = (audioCtx == null ? void 0 : audioCtx.audioContext) ? makeSharedElementSourceNode({
...
var useAppendVideoFragment = ({
  ...
  const actualFromRef = (0, import_react48.useRef)(initialActualFrom);
  const actualDuration = (0, import_react48.useRef)(initialDuration);
  const actualSrc = (0, import_react48.useRef)(initialActualSrc);
...
var useVolume = ({
  ...
  var _a, _b, _c;
  const audioStuffRef = (0, import_react45.useRef)(null);
  const currentVolumeRef = (0, import_react45.useRef)(volume);
  currentVolumeRef.current = volume;
  const sharedAudioContext = (0, import_react45.useContext)(SharedAudioContext);
...
var useBasicMediaInTimeline = ({
  ...
  const [initialVolume] = (0, import_react49.useState)(() => volume);
  ...
  const volumes = (0, import_react49.useMemo)(() => {
    if (typeof volume === "number") {
      return volume;
    }
  ...
  const memoizedResult = (0, import_react49.useMemo)(() => {
    return {
      volumes,
      duration,
      doesVolumeChange,
...
var useImageInTimeline = ({
  ...
  const parentSequence = (0, import_react49.useContext)(SequenceContext);
  const { registerSequence, unregisterSequence } = (0, import_react49.useContext)(SequenceManager);
...
var useBufferManager = (logLevel, mountTime) => {
  const [blocks, setBlocks] = (0, import_react54.useState)([]);
  const [onBufferingCallbacks, setOnBufferingCallbacks] = (0, import_react54.useState)([]);
  const [onResumeCallbacks, setOnResumeCallbacks] = (0, import_react54.useState)([]);
  const env = useRemotionEnvironment();
  const rendering = env.isRendering;
  const buffering = (0, import_react54.useRef)(false);
  const addBlock = (0, import_react54.useCallback)((block) => {
    if (rendering) {
      return {
        unblock: () => {
          return;
  ...
  const listenForBuffering = (0, import_react54.useCallback)((callback) => {
  ...
  const listenForResume = (0, import_react54.useCallback)((callback) => {
...
var BufferingContextReact = import_react54.default.createContext(null);
var BufferingProvider = ({ children }) => {
  const { logLevel, mountTime } = (0, import_react54.useContext)(LogLevelContext);
...
var useIsPlayerBuffering = (bufferManager) => {
  const [isBuffering, setIsBuffering] = (0, import_react54.useState)(bufferManager.buffering.current);
  (0, import_react54.useEffect)(() => {
    const onBuffer = () => {
      setIsBuffering(true);
    };
...
var useBufferState = () => {
  const buffer = (0, import_react53.useContext)(BufferingContextReact);
...
var useBufferUntilFirstFrame = ({
  ...
  const bufferingRef = (0, import_react52.useRef)(false);
  const { delayPlayback } = useBufferState();
  const bufferUntilFirstFrame = (0, import_react52.useCallback)((requestedTime) => {
    var _a;
    if (mediaType !== "video") {
      return;
    }
...
var useCurrentTimeOfMediaTagWithUpdateTimeStamp = (mediaRef) => {
  var _a, _b;
  const lastUpdate = import_react55.default.useRef({
...
var useMediaBuffering = ({
  ...
  const [isBuffering, setIsBuffering] = (0, import_react56.useState)(false);
...
var useRequestVideoCallbackTime = ({
  ...
  const currentTime = (0, import_react57.useRef)(null);
...
var useMediaPlayback = ({
  ...
  const buffering = (0, import_react51.useContext)(BufferingContextReact);
  const { fps } = useVideoConfig();
  const mediaStartsAt = useMediaStartsAt();
  const lastSeekDueToShift = (0, import_react51.useRef)(null);
  const lastSeek = (0, import_react51.useRef)(null);
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  if (!buffering) {
    throw new Error("useMediaPlayback must be used inside a <BufferingContext>");
  }
  const isVariableFpsVideoMap = (0, import_react51.useRef)({});
  const onVariableFpsVideoDetected = (0, import_react51.useCallback)(() => {
    if (!src) {
      return;
    }
...
var MediaVolumeContext = (0, import_react59.createContext)({
  mediaMuted: false,
  mediaVolume: 1
});
var SetMediaVolumeContext = (0, import_react59.createContext)({
  setMediaMuted: () => {
    throw new Error("default");
  },
  setMediaVolume: () => {
...
var useMediaVolumeState = () => {
  const { mediaVolume } = (0, import_react59.useContext)(MediaVolumeContext);
  const { setMediaVolume } = (0, import_react59.useContext)(SetMediaVolumeContext);
  return (0, import_react59.useMemo)(() => {
    return [mediaVolume, setMediaVolume];
  }, [mediaVolume, setMediaVolume]);
};
var useMediaMutedState = () => {
  const { mediaMuted } = (0, import_react59.useContext)(MediaVolumeContext);
  const { setMediaMuted } = (0, import_react59.useContext)(SetMediaVolumeContext);
  return (0, import_react59.useMemo)(() => {
...
var AudioForDevelopmentForwardRefFunction = (props, ref) => {
  const [initialShouldPreMountAudioElements] = (0, import_react44.useState)(props.shouldPreMountAudioTags);
  ...
  const { hidden } = (0, import_react44.useContext)(SequenceVisibilityToggleContext);
  if (!src) {
    throw new TypeError("No 'src' was passed to <Html5Audio>.");
  }
  const preloadedSrc = usePreload(src);
  const sequenceContext = (0, import_react44.useContext)(SequenceContext);
  const [timelineId] = (0, import_react44.useState)(() => String(Math.random()));
  ...
  const propsToPass = (0, import_react44.useMemo)(() => {
    return {
  ...
  const id = (0, import_react44.useMemo)(() => `audio-${random(src ?? "")}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}-muted:${props.muted}-loop:${props.loop}`, [
    src,
  ...
  const effectToUse = import_react44.default.useInsertionEffect ?? import_react44.default.useLayoutEffect;
  effectToUse(() => {
    return () => {
      requestAnimationFrame(() => {
        cleanupOnMediaTagUnmount();
  ...
  const currentOnDurationCallback = (0, import_react44.useRef)(onDuration);
...
var AudioForPreview = (0, import_react44.forwardRef)(AudioForDevelopmentForwardRefFunction);
var AudioForRenderingRefForwardingFunction = (props, ref) => {
  const audioRef = (0, import_react60.useRef)(null);
  const {
    volume: volumeProp,
    playbackRate,
    allowAmplificationDuringRender,
  ...
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const id = (0, import_react60.useMemo)(() => `audio-${random(props.src ?? "")}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    props.src,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
...
var AudioForRendering = (0, import_react60.forwardRef)(AudioForRenderingRefForwardingFunction);
...
var IFrameRefForwarding = ({
  ...
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  const [handle] = (0, import_react61.useState)(() => delayRender2(`Loading <IFrame> with source ${props2.src}`, {
    retries: delayRenderRetries ?? void 0,
    timeoutInMilliseconds: delayRenderTimeoutInMilliseconds ?? void 0
  }));
  const didLoad = (0, import_react61.useCallback)((e) => {
    continueRender2(handle);
...
var IFrame = (0, import_react61.forwardRef)(IFrameRefForwarding);
...
var ImgInner = ({
  ...
  const errors = (0, import_react62.useRef)({});
  const { delayPlayback } = useBufferState();
  const sequenceContext = (0, import_react62.useContext)(SequenceContext);
  const [timelineId] = (0, import_react62.useState)(() => String(Math.random()));
  if (!src) {
  ...
  const retryIn = (0, import_react62.useCallback)((timeout) => {
    if (!imageRef.current) {
      return;
    }
  ...
  const { delayRender: delayRender2, continueRender: continueRender2, cancelRender: cancelRender2 } = useDelayRender();
  const didGetError = (0, import_react62.useCallback)((e) => {
...
var compositionsRef = import_react64.default.createRef();
var CompositionManagerProvider = ({
  ...
  const [folders, setFolders] = (0, import_react65.useState)([]);
  const [canvasContent, setCanvasContent] = (0, import_react65.useState)(initialCanvasContent);
  const [compositions, setCompositions] = (0, import_react65.useState)(initialCompositions);
  const currentcompositionsRef = (0, import_react65.useRef)(compositions);
  const updateCompositions = (0, import_react65.useCallback)((updateComps) => {
  ...
  const registerComposition = (0, import_react65.useCallback)((comp) => {
  ...
  const unregisterComposition = (0, import_react65.useCallback)((id) => {
    setCompositions((comps) => {
      return comps.filter((c2) => c2.id !== id);
    });
  }, []);
  const registerFolder = (0, import_react65.useCallback)((name, parent, nonce) => {
  ...
  const unregisterFolder = (0, import_react65.useCallback)((name, parent) => {
    setFolders((prevFolders) => {
      return prevFolders.filter((p) => !(p.name === name && p.parent === parent));
    });
  }, []);
  (0, import_react65.useImperativeHandle)(compositionsRef, () => {
    return {
      getCompositions: () => currentcompositionsRef.current
    };
  }, []);
  const compositionManagerSetters = (0, import_react65.useMemo)(() => {
    return {
      registerComposition,
      unregisterComposition,
      registerFolder,
  ...
  const compositionManagerContextValue = (0, import_react65.useMemo)(() => {
    return {
      compositions,
      folders,
      currentCompositionMetadata,
...
var MaxMediaCacheSizeContext = import_react66.default.createContext(null);
var Root = null;
var listeners = [];
...
var MediaEnabledContext = (0, import_react68.createContext)(null);
var useVideoEnabled = () => {
  const context = (0, import_react68.useContext)(MediaEnabledContext);
  if (!context) {
...
var MediaEnabledProvider = ({
  ...
  const value = (0, import_react68.useMemo)(() => ({ videoEnabled, audioEnabled }), [videoEnabled, audioEnabled]);
...
var RemotionRootContexts = ({
  ...
  const nonceContext = (0, import_react67.useMemo)(() => {
    let counter = 0;
    return {
      getNonce: () => counter++
    };
  }, []);
  const logging = (0, import_react67.useMemo)(() => {
...
var SequenceStackTracesUpdateContext = import_react69.default.createContext(() => {
});
var getEnvVariables = () => {
  if (getRemotionEnvironment().isRendering) {
...
var CurrentScaleContext = import_react70.default.createContext(null);
var PreviewSizeContext = (0, import_react70.createContext)({
  setSize: () => {
    return;
  },
...
var useCurrentScale = (options) => {
  const hasContext = import_react70.default.useContext(CurrentScaleContext);
  const zoomContext = import_react70.default.useContext(PreviewSizeContext);
...
var useSequenceControlOverride = (key) => {
  var _a;
  const seqContext = (0, import_react71.useContext)(SequenceContext);
  const { dragOverrides: overrides } = (0, import_react71.useContext)(VisualModeOverridesContext);
  if (!seqContext) {
    return;
  }
  return (_a = overrides[seqContext.id]) == null ? void 0 : _a[key];
};
...
var OffthreadVideoForRendering = ({
  ...
  const videoConfig = useUnsafeVideoConfig();
  const sequenceContext = (0, import_react73.useContext)(SequenceContext);
  const mediaStartsAt = useMediaStartsAt();
  const { registerRenderAsset, unregisterRenderAsset } = (0, import_react73.useContext)(RenderAssetManager);
  if (!src) {
    throw new TypeError("No `src` was passed to <OffthreadVideo>.");
  }
  const id = (0, import_react73.useMemo)(() => `offthreadvideo-${random(src)}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    src,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
  ...
  const currentTime = (0, import_react73.useMemo)(() => {
  ...
  const actualSrc = (0, import_react73.useMemo)(() => {
  ...
  const [imageSrc, setImageSrc] = (0, import_react73.useState)(null);
  const { delayRender: delayRender2, continueRender: continueRender2 } = useDelayRender();
  ...
  const onErr = (0, import_react73.useCallback)(() => {
    if (onError) {
  ...
  const className = (0, import_react73.useMemo)(() => {
    return [OBJECTFIT_CONTAIN_CLASS_NAME, props2.className].filter(truthy).join(" ");
  }, [props2.className]);
  const onImageFrame = (0, import_react73.useCallback)((img) => {
    if (onVideoFrame) {
      onVideoFrame(img);
    }
  }, [onVideoFrame]);
...
var VideoForDevelopmentRefForwardingFunction = (props2, ref) => {
  const context = (0, import_react74.useContext)(SharedAudioContext);
  if (!context) {
    throw new Error("SharedAudioContext not found");
  }
  const videoRef = (0, import_react74.useRef)(null);
  const sharedSource = (0, import_react74.useMemo)(() => {
  ...
  const effectToUse = import_react74.default.useInsertionEffect ?? import_react74.default.useLayoutEffect;
  effectToUse(() => {
    return () => {
      requestAnimationFrame(() => {
  ...
  const parentSequence = (0, import_react74.useContext)(SequenceContext);
  const { hidden } = (0, import_react74.useContext)(SequenceVisibilityToggleContext);
  const logLevel = useLogLevel();
  const mountTime = useMountTime();
  const [timelineId] = (0, import_react74.useState)(() => String(Math.random()));
  const isSequenceHidden = hidden[timelineId] ?? false;
  ...
  (0, import_react74.useState)(() => playbackLogging({
    logLevel,
  ...
  const currentOnDurationCallback = (0, import_react74.useRef)(onDuration);
  currentOnDurationCallback.current = onDuration;
  ...
  const actualStyle = (0, import_react74.useMemo)(() => {
    return {
      ...style,
...
var VideoForPreview = (0, import_react74.forwardRef)(VideoForDevelopmentRefForwardingFunction);
var InnerOffthreadVideo = (props2) => {
  ...
  const onDuration = (0, import_react72.useCallback)(() => {
    return;
  }, []);
...
function useRemotionContexts() {
  const compositionManagerCtx = import_react76.default.useContext(CompositionManager);
  const timelineContext = import_react76.default.useContext(TimelineContext);
  const setTimelineContext = import_react76.default.useContext(SetTimelineContext);
  const sequenceContext = import_react76.default.useContext(SequenceContext);
  const nonceContext = import_react76.default.useContext(NonceContext);
  const canUseRemotionHooksContext = import_react76.default.useContext(CanUseRemotionHooks);
  const preloadContext = import_react76.default.useContext(PreloadContext);
  const resolveCompositionContext = import_react76.default.useContext(ResolveCompositionContext);
  const renderAssetManagerContext = import_react76.default.useContext(RenderAssetManager);
  const sequenceManagerContext = import_react76.default.useContext(SequenceManager);
  const bufferManagerContext = import_react76.default.useContext(BufferingContextReact);
  const logLevelContext = import_react76.default.useContext(LogLevelContext);
...
var compositionSelectorRef = (0, import_react63.createRef)();
var Internals = {
...
var flattenChildren = (children) => {
  const childrenArray = import_react78.default.Children.toArray(children);
  return childrenArray.reduce((flatChildren, child) => {
    if (child.type === import_react78.default.Fragment) {
...
var IsInsideSeriesContext = (0, import_react79.createContext)(false);
...
var useRequireToBeInsideSeries = () => {
  const isInsideSeries = import_react79.default.useContext(IsInsideSeriesContext);
  if (!isInsideSeries) {
...
var SeriesSequence = (0, import_react77.forwardRef)(SeriesSequenceRefForwardingFunction);
var Series = (props2) => {
  const childrenValue = (0, import_react77.useMemo)(() => {
    let startFrame = 0;
    const flattenedChildren = flattenChildren(props2.children);
    return import_react77.Children.map(flattenedChildren, (child, i) => {
...
var Still = (props2) => {
  ...
  return import_react80.default.createElement(Composition, newProps);
};
...
var VideoForRenderingForwardFunction = ({
  ...
  const videoConfig = useUnsafeVideoConfig();
  const videoRef = (0, import_react82.useRef)(null);
  ...
  const id = (0, import_react82.useMemo)(() => `video-${random(props2.src ?? "")}-${sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom}-${sequenceContext == null ? void 0 : sequenceContext.relativeFrom}-${sequenceContext == null ? void 0 : sequenceContext.durationInFrames}`, [
    props2.src,
    sequenceContext == null ? void 0 : sequenceContext.cumulatedFrom,
    sequenceContext == null ? void 0 : sequenceContext.relativeFrom,
    sequenceContext == null ? void 0 : sequenceContext.durationInFrames
...
var VideoForRendering = (0, import_react82.forwardRef)(VideoForRenderingForwardFunction);
var VideoForwardingFunction = (props2, ref) => {
  ...
  const { durations, setDurations } = (0, import_react81.useContext)(DurationsContext);
  ...
  const onDuration = (0, import_react81.useCallback)((src, durationInSeconds) => {
    setDurations({ type: "got-duration", durationInSeconds, src });
  }, [setDurations]);
  const onVideoFrame = (0, import_react81.useCallback)(() => {
  }, []);
...
var Html5Video = (0, import_react81.forwardRef)(VideoForwardingFunction);
...
//# sourceMappingURL=chunk-KZKZVUBZ.js.map
