...
// ../../node_modules/.pnpm/@designcombo+frames@0.0.3/node_modules/@designcombo/frames/dist/frames.js
var He = Object.defineProperty;
var pe = (l) => {
  throw TypeError(l);
};
var Ye = (l, r, h) => r in l ? He(l, r, { enumerable: true, configurable: true, writable: true, value: h }) : l[r] = h;
var R = (l, r, h) => Ye(l, typeof r != "symbol" ? r + "" : r, h);
var _e = (l, r, h) => r.has(l) || pe("Cannot " + h);
var m = (l, r, h) => (_e(l, r, "read from private field"), h ? h.call(l) : r.get(l));
var A = (l, r, h) => r.has(l) ? pe("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(l) : r.set(l, h);
var E = (l, r, h, a) => (_e(l, r, "write to private field"), a ? a.call(l, h) : r.set(l, h), h);
function Ve(l) {
...
var Fe = (l, r, h) => r.has(l) || Be("Cannot " + h);
var I = (l, r, h) => (Fe(l, r, "read from private field"), h ? h.call(l) : r.get(l));
var N = (l, r, h) => r.has(l) ? Be("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(l) : r.set(l, h);
var M = (l, r, h, a) => (Fe(l, r, "write to private field"), r.set(l, h), h);
var Ie = "";
var Ze = (l) => Uint8Array.from(atob(l), (r) => r.charCodeAt(0));
var ge = typeof self < "u" && self.Blob && new Blob([Ze(Ie)], { type: "text/javascript;charset=utf-8" });
function Xe(l) {
  let r;
  try {
...
async function Ce(l) {
  ...
  if (r == null) {
    ...
    for await (const d of f.keys())
      await f.removeEntry(d, { recursive: true });
    return;
  }
  const a = await ot(r, {
    create: false,
  ...
  a != null && await a.removeEntry(h, { recursive: true });
}
function se(l, r) {
  return `${l}/${r}`.replace("//", "/");
}
...
async function Ct(l, r, h = { overwrite: true }) {
  if (r instanceof jt) {
...
var $e = class Te {
  constructor(r, h) {
    ...
    })()), N(this, It, false), M(this, Zt, Je()), M(this, Y, r), M(this, Ft, {
      r: "read-only",
      rw: "readwrite",
  ...
  async createWriter() {
    ...
    return {
      ...
      close: async () => {
        if (d) throw Error("Writer is closed");
        d = true, M(this, It, false), await a();
      }
    };
  }
  /**
  ...
  async arrayBuffer() {
    const r = await ot(I(this, Y), { create: false, isFile: true });
  ...
  async getOriginFile() {
    var r;
    return (r = await ot(I(this, Y), { create: false, isFile: true })) == null ? void 0 : r.getFile();
  }
  async getSize() {
    const r = await ot(I(this, Y), { create: false, isFile: true });
...
var jt = $e;
var he = "/.opfs-tools-temp-dir";
async function Pe(l) {
  try {
    if (l.kind === "file") {
      if (!await l.exists()) return true;
...
async function ti() {
  ...
  me || (me = true, globalThis.addEventListener("unload", () => {
...
(async function() {
  var l;
  globalThis.__opfs_tools_tmpfile_init__ !== true && (globalThis.__opfs_tools_tmpfile_init__ = true, !(globalThis.FileSystemDirectoryHandle == null || globalThis.FileSystemFileHandle == null || ((l = globalThis.navigator) == null ? void 0 : l.storage.getDirectory) == null) && (qe(), await ti()));
})();
function Kt() {
...
var ke = Kt();
var gt = null;
var ve = ["debug", "info", "warn", "error"].reduce(
...
var si = globalThis.navigator == null ? null : ni();
var ri = () => {
  let l, r = 16.6;
  self.onmessage = (h) => {
...
async function bi(l, r, h) {
  ...
  if (globalThis.OfflineAudioContext == null)
    return l.map(
      (b) => new Float32Array(
        _i(b, r, h.rate, { method: "sinc", LPF: false })
      )
    );
...
(function(l) {
  ...
  }, a.BIG_ENDIAN = false, a.LITTLE_ENDIAN = true, a.prototype._byteLength = 0, Object.defineProperty(
    a.prototype,
    "byteLength",
    { get: function() {
  ...
  }, a.prototype._dynamicSize = true, Object.defineProperty(
    a.prototype,
    "dynamicSize",
    {
      get: function() {
  ...
  d.prototype = new a(new ArrayBuffer(), 0, a.BIG_ENDIAN), d.prototype.initialized = function() {
    var t;
    return this.bufferIndex > -1 ? true : this.buffers.length > 0 ? (t = this.buffers[0], t.fileStart === 0 ? (this.buffer = t, this.bufferIndex = 0, r.debug("MultiBufferStream", "Stream ready for parsing"), true) : (r.warn("MultiBufferStream", "The first buffer should have a fileStart of 0"), this.logBufferLevel(), false)) : (r.warn("MultiBufferStream", "No buffer to start parsing from"), this.logBufferLevel(), false);
    ...
    for (var e = true, i = 0; i < this.buffers.length; i++) {
    ...
    if (this.bufferIndex + 1 < this.buffers.length)
      if (t = this.buffers[this.bufferIndex + 1], t.fileStart === this.buffer.fileStart + this.buffer.byteLength) {
        ...
        return this.buffers[this.bufferIndex] = ArrayBuffer.concat(this.buffer, t), this.buffer = this.buffers[this.bufferIndex], this.buffers.splice(this.bufferIndex + 1, 1), this.buffer.usedBytes = i, this.buffer.fileStart = s, r.debug("ISOFile", "Concatenating buffer for box parsing (length: " + e + "->" + this.buffer.byteLength + ")"), true;
      } else
        return false;
    else
      return false;
    ...
    var s, o = null, c = -1;
    for (t === true ? s = 0 : s = this.bufferIndex; s < this.buffers.length && (o = this.buffers[s], o.fileStart <= e); ) {
    ...
    var s;
    return s = this.findPosition(e, t, i), s !== -1 ? (this.buffer = this.buffers[s], this.bufferIndex = s, this.position = t - this.buffer.fileStart, r.debug("MultiBufferStream", "Repositioning parser at buffer position: " + this.position), true) : (r.debug("MultiBufferStream", "Position " + t + " not found in buffered data"), false);
  ...
  n.initialize(), n.TKHD_FLAG_ENABLED = 1, n.TKHD_FLAG_IN_MOVIE = 2, n.TKHD_FLAG_IN_PREVIEW = 4, n.TFHD_FLAG_BASE_DATA_OFFSET = 1, n.TFHD_FLAG_SAMPLE_DESC = 2, n.TFHD_FLAG_SAMPLE_DUR = 8, n.TFHD_FLAG_SAMPLE_SIZE = 16, n.TFHD_FLAG_SAMPLE_FLAGS = 32, n.TFHD_FLAG_DUR_EMPTY = 65536, n.TFHD_FLAG_DEFAULT_BASE_IS_MOOF = 131072, n.TRUN_FLAGS_DATA_OFFSET = 1, n.TRUN_FLAGS_FIRST_FLAG = 4, n.TRUN_FLAGS_DURATION = 256, n.TRUN_FLAGS_SIZE = 512, n.TRUN_FLAGS_FLAGS = 1024, n.TRUN_FLAGS_CTS_OFFSET = 2048, n.Box.prototype.add = function(t) {
    ...
    return g !== 0 && g < c ? (r.error("BoxParser", "Box of type " + w + " has an invalid size " + g + " (too small to be a box)"), { code: n.ERR_NOT_ENOUGH_DATA, type: w, size: g, hdr_size: c, start: o }) : g !== 0 && i && g > i ? (r.error("BoxParser", "Box of type '" + w + "' has a size " + g + " greater than its container size " + i), { code: n.ERR_NOT_ENOUGH_DATA, type: w, size: g, hdr_size: c, start: o }) : g !== 0 && o + g > t.getEndPosition() ? (t.seek(o), r.info("BoxParser", "Not enough data in stream to parse the entire '" + w + "' box"), { code: n.ERR_NOT_ENOUGH_DATA, type: w, size: g, hdr_size: c, start: o }) : e ? { code: n.OK, type: w, size: g, hdr_size: c, start: o } : (n[w + "Box"] ? s = new n[w + "Box"](g) : w !== "uuid" ? (r.warn("BoxParser", "Unknown box type: '" + w + "'"), s = new n.Box(w, g), s.has_unparsed_data = true) : n.UUIDBoxes[_] ? s = new n.UUIDBoxes[_](g) : (r.warn("BoxParser", "Unknown uuid type: '" + _ + "'"), s = new n.Box(w, g), s.uuid = _, s.has_unparsed_data = true), s.hdr_size = c, s.start = o, s.write === n.Box.prototype.write && s.type !== "mdat" && (r.info("BoxParser", "'" + S + "' box writing not yet implemented, keeping unparsed data in memory for later write"), s.parseDataAndRewind(t)), s.parse(t), u = t.getPosition() - (s.start + s.size), u < 0 ? (r.warn("BoxParser", "Parsing of box '" + S + "' did not read the entire indicated box data size (missing " + -u + " bytes), seeking forward"), t.seek(s.start + s.size)) : u > 0 && (r.error("BoxParser", "Parsing of box '" + S + "' read " + u + " more bytes than the indicated box data size, seeking backwards"), s.size !== 0 && t.seek(s.start + s.size)), { code: n.OK, box: s, size: s.size });
    ...
    for (var e, i; t.getPosition() < this.start + this.size; )
      if (e = n.parseOneBox(t, false, this.size - (t.getPosition() - this.start)), e.code === n.OK)
    ...
    for (this.references = []; t.getPosition() < this.start + this.size; )
      if (e = n.parseOneBox(t, true, this.size - (t.getPosition() - this.start)), e.code === n.OK)
    ...
    for (this.entries = [], s = t.readUint32(), e = 1; e <= s; e++)
      if (i = n.parseOneBox(t, true, this.size - (t.getPosition() - this.start)), i.code === n.OK)
    ...
    for (this.boxes = []; t.getPosition() < this.start + this.size; )
      if (s = n.parseOneBox(t, false, this.size - (t.getPosition() - this.start)), s.code === n.OK)
    ...
    for (this.track_ID = t.readUint32(), this.boxes = []; t.getPosition() < this.start + this.size; )
      if (ret = n.parseOneBox(t, false, this.size - (t.getPosition() - this.start)), ret.code === n.OK)
  ...
  }), n.createUUIDBox("a5d40b30e81411ddba2f0800200c9a66", true, false, function(t) {
    this.LiveServerManifest = t.readString(this.size - this.hdr_size).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;");
  }), n.createUUIDBox("d08a4f1810f34a82b6c832d8aba183d3", true, false, function(t) {
  ...
  ), n.createUUIDBox("8974dbce7be74c5184f97148f9882554", true, false, function(t) {
    this.default_AlgorithmID = t.readUint24(), this.default_IV_size = t.readUint8(), this.default_KID = n.parseHex16(t);
  }), n.createUUIDBox("d4807ef2ca3946958e5426cb9e46a79f", true, false, function(t) {
  ...
  }), n.createUUIDBox("6d1d9b0542d544e680e2141daff757b2", true, false, function(t) {
    ...
    if (this.hvcC) {
      ...
      var o = false, c = "";
      for (t = 5; t >= 0; t--)
        (this.hvcC.general_constraint_indicator[t] || o) && (c = "." + n.decimalToHex(this.hvcC.general_constraint_indicator[t], 0) + c, o = true);
      e += c;
    }
    return e;
  ...
  y.prototype.setSegmentOptions = function(t, e, i) {
    ...
    return t.byteLength === 0 ? (r.warn("ISOFile", "Ignoring empty buffer (fileStart: " + t.fileStart + ")"), this.stream.logBufferLevel(), false) : (r.info("ISOFile", "Processing buffer (fileStart: " + t.fileStart + ")"), t.usedBytes = 0, this.stream.insertBuffer(t), this.stream.logBufferLevel(), this.stream.initialized() ? true : (r.warn("ISOFile", "Not ready to start parsing"), false));
  }, y.prototype.appendBuffer = function(t, e) {
    var i;
    if (this.checkBuffer(t))
      return this.parse(), this.moovStartFound && !this.moovStartSent && (this.moovStartSent = true, this.onMoovStart && this.onMoovStart()), this.moov ? (this.sampleListBuilt || (this.buildSampleLists(), this.sampleListBuilt = true), this.updateSampleLists(), this.onReady && !this.readySent && (this.readySent = true, this.onReady(this.getInfo())), this.processSamples(e), this.nextSeekPosition ? (i = this.nextSeekPosition, this.nextSeekPosition = void 0) : i = this.nextParsePosition, this.stream.getEndFilePositionAfter && (i = this.stream.getEndFilePositionAfter(i))) : this.nextParsePosition ? i = this.nextParsePosition : i = 0, this.sidx && this.onSidx && !this.sidxSent && (this.onSidx(this.sidx), this.sidxSent = true), this.meta && (this.flattenItemInfo && !this.itemListBuilt && (this.flattenItemInfo(), this.itemListBuilt = true), this.processItems && this.processItems(this.onItem)), this.stream.cleanBuffers && (r.info("ISOFile", "Done processing buffer (fileStart: " + t.fileStart + ") - next buffer to fetch should have a fileStart position of " + i), this.stream.logBufferLevel(), this.stream.cleanBuffers(), this.stream.logBufferLevel(true), r.info("ISOFile", "Sample data size in memory: " + this.getAllocatedSampleDataSize())), i;
  }, y.prototype.getInfo = function() {
    var t, e, i = {}, s, o, c, u, _ = (/* @__PURE__ */ new Date("1904-01-01T00:00:00Z")).getTime();
    if (this.moov)
      for (i.hasMoov = true, i.duration = this.moov.mvhd.duration, i.timescale = this.moov.mvhd.timescale, i.isFragmented = this.moov.mvex != null, i.isFragmented && this.moov.mvex.mehd && (i.fragment_duration = this.moov.mvex.mehd.fragment_duration), i.isProgressive = this.isProgressive, i.hasIOD = this.moov.iods != null, i.brands = [], i.brands.push(this.ftyp.major_brand), i.brands = i.brands.concat(this.ftyp.compatible_brands), i.created = new Date(_ + this.moov.mvhd.creation_time * 1e3), i.modified = new Date(_ + this.moov.mvhd.modification_time * 1e3), i.tracks = [], i.audioTracks = [], i.videoTracks = [], i.subtitleTracks = [], i.metadataTracks = [], i.hintTracks = [], i.otherTracks = [], t = 0; t < this.moov.traks.length; t++) {
    ...
    r.info("ISOFile", "Flushing remaining samples"), this.updateSampleLists(), this.processSamples(true), this.stream.cleanBuffers(), this.stream.logBufferLevel(true);
    ...
    return true;
  }, l.ISOFile = y, y.prototype.lastBoxStartPosition = 0, y.prototype.parsingMdat = null, y.prototype.nextParsePosition = 0, y.prototype.discardMdatData = false, y.prototype.processIncompleteBox = function(t) {
    var e, i, s;
    return t.type === "mdat" ? (e = new n[t.type + "Box"](t.size), this.parsingMdat = e, this.boxes.push(e), this.mdats.push(e), e.start = t.start, e.hdr_size = t.hdr_size, this.stream.addUsedBytes(e.hdr_size), this.lastBoxStartPosition = e.start + e.size, s = this.stream.seek(e.start + e.size, false, this.discardMdatData), s ? (this.parsingMdat = null, true) : (this.moovStartFound ? this.nextParsePosition = this.stream.findEndContiguousBuf() : this.nextParsePosition = e.start + e.size, false)) : (t.type === "moov" && (this.moovStartFound = true, this.mdats.length === 0 && (this.isProgressive = true)), i = this.stream.mergeNextBuffer ? this.stream.mergeNextBuffer() : false, i ? (this.nextParsePosition = this.stream.getEndPosition(), true) : (t.type ? this.moovStartFound ? this.nextParsePosition = this.stream.getEndPosition() : this.nextParsePosition = this.stream.getPosition() + t.size : this.nextParsePosition = this.stream.getEndPosition(), false));
  }, y.prototype.hasIncompleteMdat = function() {
    return this.parsingMdat !== null;
  }, y.prototype.processIncompleteMdat = function() {
    var t, e;
    return t = this.parsingMdat, e = this.stream.seek(t.start + t.size, false, this.discardMdatData), e ? (r.debug("ISOFile", "Found 'mdat' end in buffered data"), this.parsingMdat = null, true) : (this.nextParsePosition = this.stream.findEndContiguousBuf(), false);
    ...
    for (e && (e.sample_groups_info = []), t.sample_groups_info || (t.sample_groups_info = []), u = 0; u < i.length; u++) {
      for (g = i[u].grouping_type + "/" + i[u].grouping_type_parameter, _ = new w(i[u].grouping_type, i[u].grouping_type_parameter, i[u]), e && (e.sample_groups_info[g] = _), t.sample_groups_info[g] || (t.sample_groups_info[g] = _), c = 0; c < s.length; c++)
        s[c].grouping_type === i[u].grouping_type && (_.description = s[c], _.description.used = true);
      if (o)
        for (c = 0; c < o.length; c++)
          o[c].grouping_type === i[u].grouping_type && (_.fragment_description = o[c], _.fragment_description.used = true, _.is_fragment = true);
    }
    if (e) {
      if (o)
        for (u = 0; u < o.length; u++)
          !o[u].used && o[u].version >= 2 && (g = o[u].grouping_type + "/0", _ = new w(o[u].grouping_type, 0), _.is_fragment = true, e.sample_groups_info[g] || (e.sample_groups_info[g] = _));
    } else
      ...
      for (; this.lastMoofIndex < this.moofs.length; )
        if (g = this.moofs[this.lastMoofIndex], this.lastMoofIndex++, g.type == "moof")
          for (w = g, t = 0; t < w.trafs.length; t++) {
            ...
            if (S.subs) {
              U.has_fragment_subsamples = true;
    ...
    if (!s.data)
      ...
      return s;
    for (; ; ) {
      var o = this.stream.findPosition(true, s.offset + s.alreadyRead, false);
      if (o > -1) {
    ...
    if (o != null && o.hdlr !== void 0 && o.iinf !== void 0) {
      ...
      if (o.pitm && (t[o.pitm.item_id].primary = true), o.iref)
    ...
    for (var s = 0; s < i.extents.length; s++) {
      ...
      if (o.alreadyRead !== o.length) {
        var c = this.stream.findPosition(true, o.offset + o.alreadyRead, false);
        if (c > -1) {
    ...
    var t, e, i, s;
    for (this.onSegment === null && r.warn("MP4Box", "No segmentation callback set!"), this.isFragmentationInitialized || (this.isFragmentationInitialized = true, this.nextMoofNumber = 0, this.resetTables()), e = [], t = 0; t < this.fragmentedTracks.length; t++) {
      var o = new n.moovBox();
  ...
  B.createFile = function(t, e) {
    var i = t !== void 0 ? t : true, s = new y(e);
...
var sn = class {
  constructor(r, h = {}) {
    ...
    A(this, V, { audio: true });
    R(this, "tickInterceptor", async (r2, h2) => h2);
    A(this, Q, new AbortController());
    if (!(r instanceof ReadableStream) && !ne(r) && !Array.isArray(r.videoSamples))
      throw Error("Illegal argument");
    E(this, V, { audio: true, ...h }), E(this, Lt, typeof h.audio == "object" && "volume" in h.audio ? h.audio.volume : 1);
    ...
    E(this, K, ne(r) ? r : "localFile" in r ? r.localFile : Kt()), this.ready = (r instanceof ReadableStream ? a(r).then((f) => xe(f, m(this, V))) : ne(r) ? r.stream().then((f) => xe(f, m(this, V))) : Promise.resolve(r)).then(async ({ videoSamples: f, audioSamples: d, decoderConf: p }) => {
      ...
      const { videoFrameFinder: n, audioFrameFinder: v } = Ii(
        ...
        f,
        d,
        m(this, V).audio !== false ? m(this, Lt) : 0
      );
  ...
  destroy() {
    var r, h;
    m(this, Pt) || (m(this, Tt).info("MP4Clip destroy"), E(this, Pt, true), (r = m(this, wt)) == null || r.destroy(), (h = m(this, bt)) == null || h.destroy());
  }
};
Tt = /* @__PURE__ */ new WeakMap(), Pt = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), Lt = /* @__PURE__ */ new WeakMap(), st = /* @__PURE__ */ new WeakMap(), wt = /* @__PURE__ */ new WeakMap(), bt = /* @__PURE__ */ new WeakMap(), St = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap();
function Fi(l, r, h) {
  const a = {
    duration: 0,
    width: 0,
...
var oe = class {
  constructor(r, h, a) {
    A(this, L, null);
    A(this, lt, 0);
    A(this, ft, { abort: false, st: performance.now() });
    R(this, "find", async (r2) => ((m(this, L) == null || r2 <= m(this, lt) || r2 - m(this, lt) > 3e6) && m(this, ut).call(this, r2), m(this, ft).abort = true, E(this, lt, r2), E(this, ft, { abort: false, st: performance.now() }), await m(this, xt).call(this, r2, m(this, L), m(this, ft))));
    A(this, kt, 0);
    A(this, dt, false);
    A(this, W, 0);
    A(this, k, []);
    A(this, rt, 0);
    A(this, ct, 0);
    A(this, xt, async (r2, h2, a2) => {
      if (h2 == null || h2.state === "closed" || a2.abort) return null;
      if (m(this, k).length > 0) {
        const f = m(this, k)[0];
        return r2 < f.timestamp ? null : (m(this, k).shift(), r2 > f.timestamp + (f.duration ?? 0) ? (f.close(), await m(this, xt).call(this, r2, h2, a2)) : (m(this, k).length < 10 && m(this, Dt).call(this, h2).catch((d) => {
          throw m(this, ut).call(this, r2), d;
        }), f));
      }
      if (m(this, at) || m(this, rt) < m(this, ct) && h2.decodeQueueSize > 0) {
        if (performance.now() - a2.st > 6e3)
          throw Error(
        ...
        if (m(this, W) >= this.samples.length)
          return null;
        try {
          await m(this, Dt).call(this, h2);
        } catch (f) {
          throw m(this, ut).call(this, r2), f;
        }
      }
      return await m(this, xt).call(this, r2, h2, a2);
    });
    A(this, at, false);
    A(this, Dt, async (r2) => {
      var f, d;
      if (m(this, at)) return;
      E(this, at, true);
      let h2 = m(this, W) + 1, a2 = false;
      for (; h2 < this.samples.length; h2++) {
        const p = this.samples[h2];
        if (!a2 && !p.deleted && (a2 = true), p.is_idr) break;
      }
      if (a2) {
        const p = this.samples.slice(m(this, W), h2);
        if (((f = p[0]) == null ? void 0 : f.is_idr) !== true)
          z.warn("First sample not idr frame");
        else {
          const n = await Li(p, this.localFileReader);
          if (r2.state === "closed") return;
          E(this, kt, ((d = n[0]) == null ? void 0 : d.duration) ?? 0), ki(r2, n, {
            onDecodingError: (v) => {
              if (m(this, dt))
                throw v;
              m(this, rt) === 0 && (E(this, dt, true), z.warn("Downgrade to software decode"), m(this, ut).call(this));
            }
          }), E(this, ct, m(this, ct) + n.length);
        }
      }
      E(this, W, h2), E(this, at, false);
    });
    A(this, ut, (r2) => {
      var h2, a2;
      if (E(this, at, false), m(this, k).forEach((f) => f.close()), E(this, k, []), r2 == null || r2 === 0)
        E(this, W, 0);
      else {
        let f = 0;
        for (let d = 0; d < this.samples.length; d++) {
          const p = this.samples[d];
          if (p.is_idr && (f = d), !(p.cts < r2)) {
            E(this, W, f);
            break;
          }
        }
      }
      E(this, ct, 0), E(this, rt, 0), ((h2 = m(this, L)) == null ? void 0 : h2.state) !== "closed" && ((a2 = m(this, L)) == null || a2.close()), E(this, L, new VideoDecoder({
        output: (f) => {
    ...
    A(this, Jt, () => {
      ...
      return {
        time: m(this, lt),
        decState: (r2 = m(this, L)) == null ? void 0 : r2.state,
        decQSize: (h2 = m(this, L)) == null ? void 0 : h2.decodeQueueSize,
    ...
    R(this, "destroy", () => {
      var r2, h2;
      ((r2 = m(this, L)) == null ? void 0 : r2.state) !== "closed" && ((h2 = m(this, L)) == null || h2.close()), E(this, L, null), m(this, ft).abort = true, m(this, k).forEach((a2) => a2.close()), E(this, k, []), this.localFileReader.close();
    });
    this.localFileReader = r, this.samples = h, this.conf = a;
  }
};
L = /* @__PURE__ */ new WeakMap(), lt = /* @__PURE__ */ new WeakMap(), ft = /* @__PURE__ */ new WeakMap(), kt = /* @__PURE__ */ new WeakMap(), dt = /* @__PURE__ */ new WeakMap(), W = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), rt = /* @__PURE__ */ new WeakMap(), ct = /* @__PURE__ */ new WeakMap(), xt = /* @__PURE__ */ new WeakMap(), at = /* @__PURE__ */ new WeakMap(), Dt = /* @__PURE__ */ new WeakMap(), ut = /* @__PURE__ */ new WeakMap(), Jt = /* @__PURE__ */ new WeakMap();
var Rt;
var Mt;
var Z;
var pt;
...
var Ci = class {
  constructor(r, h, a, f) {
    ...
    A(this, Mt);
    A(this, Z, null);
    A(this, pt, { abort: false, st: performance.now() });
    R(this, "find", async (r2) => {
      if (m(this, Z) == null || r2 <= m(this, X) || r2 - m(this, X) > 1e5) {
        m(this, $t).call(this), E(this, X, r2);
        for (let a2 = 0; a2 < this.samples.length; a2++)
          if (!(this.samples[a2].cts < r2)) {
            E(this, J, a2);
            break;
          }
        return [];
      }
      m(this, pt).abort = true;
      const h2 = r2 - m(this, X);
      return E(this, X, r2), E(this, pt, { abort: false, st: performance.now() }), await m(this, Ot).call(this, h2, m(this, Z), m(this, pt));
    });
    A(this, X, 0);
    A(this, J, 0);
    A(this, j, {
    ...
    A(this, Ot, async (r2, h2 = null, a2) => {
      if (h2 == null || a2.abort || h2.state === "closed") return [];
      const f2 = Math.ceil(r2 * (m(this, Mt) / 1e6));
      if (f2 === 0) return [];
      const d = m(this, j).frameCnt - f2;
      if (d > 0)
        return d < q.sampleRate / 10 && m(this, Nt).call(this, h2), Pi(m(this, j), f2);
      if (h2.decodeQueueSize > 10) {
        if (performance.now() - a2.st > 3e3)
          throw a2.abort = true, Error(
        ...
        if (m(this, J) >= this.samples.length - 1)
          return [];
        m(this, Nt).call(this, h2);
      }
      return m(this, Ot).call(this, r2, h2, a2);
    });
    A(this, Nt, (r2) => {
      if (r2.decodeQueueSize > 100) return;
      const h2 = [];
      let a2 = m(this, J);
      for (; a2 < this.samples.length; ) {
        const f2 = this.samples[a2];
        if (a2 += 1, !f2.deleted && (h2.push(f2), h2.length >= 10))
          break;
      }
      E(this, J, a2), r2.decode(
        h2.map(
          (f2) => new EncodedAudioChunk({
            type: "key",
            timestamp: f2.cts,
    ...
    A(this, $t, () => {
      ...
      E(this, X, 0), E(this, J, 0), E(this, j, {
        frameCnt: 0,
        data: []
      }), (r2 = m(this, Z)) == null || r2.close(), E(this, Z, zi(
        this.conf,
        {
        ...
        (h2) => {
          m(this, j).data.push(h2), m(this, j).frameCnt += h2[0].length;
        }
      ));
    });
    A(this, qt, () => {
      ...
      return {
        time: m(this, X),
        decState: (r2 = m(this, Z)) == null ? void 0 : r2.state,
        decQSize: (h2 = m(this, Z)) == null ? void 0 : h2.decodeQueueSize,
    ...
    R(this, "destroy", () => {
      E(this, Z, null), m(this, pt).abort = true, E(this, j, {
        frameCnt: 0,
        data: []
...
Rt = /* @__PURE__ */ new WeakMap(), Mt = /* @__PURE__ */ new WeakMap(), Z = /* @__PURE__ */ new WeakMap(), pt = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), Ot = /* @__PURE__ */ new WeakMap(), Nt = /* @__PURE__ */ new WeakMap(), $t = /* @__PURE__ */ new WeakMap(), qt = /* @__PURE__ */ new WeakMap();
function zi(l, r, h) {
  const a = (n) => {
    if (n.length !== 0) {
      if (r.volume !== 1)
...
function Di(l, r) {
  if (r !== "avc1" && r !== "hvc1") return false;
  const h = new DataView(l.buffer);
  let a = 0;
  for (; a < l.byteLength - 4; ) {
    if (r === "avc1") {
      if ((h.getUint8(a + 4) & 31) === 5) return true;
...
function rn(l) {
  ...
  let f = false;
  const d = () => {
    r.moov == null || f || (f = true, l.metaDataTags != null && a(r.moov, l.metaDataTags), l.duration != null && (r.moov.mvhd.duration = l.duration));
  };
...
function Wi(l, r, h) {
  ...
  return {
    stream: new ReadableStream({
      ...
      cancel() {
        b = true, clearInterval(a), h == null || h();
      }
    }),
    stop: (t) => {
      v || (v = true, y == null || y(t));
...
function Zi(l) {
  ...
  return async () => {
    ...
    if (t = true, await B, clearInterval(v), !n() || y == null) return null;
    l.flush(), await d(), await (y == null ? void 0 : y.close());
    const i = p.find((c) => c.type === "moov");
    if (i == null) return null;
    i.mvhd.duration = f;
    const s = Kt(), o = e(p, 0);
    return await Ct(s, o), await Ct(s, b, { overwrite: false }), await s.stream();
  };
  function e(i, s) {
...
function on(l, r) {
  ...
  let d = null, p = null, n = [], v = 0, b = 0, y = 0, B = true, t = 48e3;
...
//# sourceMappingURL=@designcombo_frames.js.map
