...
// ../../node_modules/.pnpm/@designcombo+animations@5.5.8_@designcombo+events@1.0.2_@designcombo+types@5.5.8_react@_ab0bde0335c3a351576ece5094e6a5b6/node_modules/@designcombo/animations/dist/index.es.js
...
var F = (t, a, e, s = false, l = false) => import_react.default.useMemo(() => {
  ...
  if (o.length !== t.length && console.error("Some animations are invalid and will be ignored"), l) {
    const c = [], r = {};
    o.reverse().forEach((n) => {
      const d = E(n, e, a, false);
      if (n.persist === true && e - (n.delay || 0) >= n.durationInFrames) {
...
var z = ({
  ...
  const r = F(
    ...
    o,
    true
  ), i = import_react.default.useMemo(() => {
  ...
  }, [r, o, t]), n = import_react.default.useMemo(() => {
  ...
  }, [f, o, a]), u = ((l == null ? void 0 : l.transform) || "").match(/rotate\((-?[\d.]+)deg\)/), v = u ? parseFloat(u[1]) : 0, g = -v, p = import_react.default.useMemo(() => {
    const h = {
      ...i
      // , ...timedStyle
    };
...
var L = ({
  ...
  const o = F(
    ...
    false,
    true
  ), r = ((s == null ? void 0 : s.transform) || "").match(/rotate\((-?[\d.]+)deg\)/), f = r ? parseFloat(r[1]) : 0, i = -f, n = import_react.default.useMemo(() => ({
    ...o
  }), [o]);
...
//# sourceMappingURL=@designcombo_animations.js.map
