...
const SHAPES = [
	...
	},
	{
		id: "star",
		label: "כוכב",
		svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><polygon points="50,5 61,35 95,35 68,57 79,91 50,70 21,91 32,57 5,35 39,35" fill="none" stroke="black" stroke-width="5" stroke-linejoin="round"/></svg>`,
		width: 80,
		height: 80,
	},
	{
		id: "heart",
		label: "לב",
		svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path d="M50,85 C50,85 10,60 10,30 C10,15 22,5 35,5 C42,5 48,9 50,13 C52,9 58,5 65,5 C78,5 90,15 90,30 C90,60 50,85 50,85 Z" fill="none" stroke="black" stroke-width="5" stroke-linejoin="round"/></svg>`,
		width: 80,
		height: 80,
	},
